...
public:
    long long dividePlayers(vector<int>& skill) {
        ...
        int n = skill.size();
        long long totalChem = 0; //stores total chemistry calculated by multiplying individual chemistries
        ...
        for(int i=0;i<n/2;i++){
            ...
            totalChem += (long long)skill[i]*(long long)skill[n-1-i]; //calculate total chemistry by adding individual team chemistry
        }
